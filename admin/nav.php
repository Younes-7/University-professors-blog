                    ...
                    <div class=" container ">
                        <div class="header-menu header-menu-left header-menu-mobile  header-menu-layout-default header-menu-root-arrow ">
                            <ul class="menu-nav ">
                                ...
                                <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="Categories.php" class="menu-link menu-toggle"><span class="menu-text">دانشکده ها</span><i class="menu-arrow"></i></a>
                                </li>
                                <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="Posts.php" class="menu-link menu-toggle"><span class="menu-text">مدیریت اساتید</span><i class="menu-arrow"></i></a>
                                </li>
                                <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true"><a href="Comments.php" class="menu-link menu-toggle"><span class="menu-text">نظرات دانشجو ها</span><i class="menu-arrow"></i></a>
                                </li>
