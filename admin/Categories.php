    ...
    ?>
                                        <div class="card card-custom gutter-b example example-compact">
                                            ...
                                            <div class="form-group">
                                                        <label>دانشکده </label>
                                                        <input name="cate_title" type="text" class="form-control form-control-lg"  placeholder="اسم  دانشکده را وارد کنید"/>
                                                    </div>
                                            </div>
...
?>
                <td colspan="3" class="alert alert-info">دانشکده ای وجود ندارد</td>
            <?php } ?>
                                                </tbody>
                                            </table>
                                            </div>
