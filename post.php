          ...
          <div class="row align-items-center align-content-center">
            <div class="col-md-12 mt-4 mt-md-0">
              <div class="home-img text-center bg-secondary py-4">
                <img src="images/<?php echo $value->post_img ?>" width="250px" height="250px" class="rounded-circle mx-5 d-block" alt="profile img">
              ...
              <div class="col">
                <div class="card">
                  ...
                  <div class="card-footer">
                    <small class="text-muted"> درجه استاد :<?php echo $value->post_author ?></small>
          ...
          <div class="row d-flex justify-content-center">
            ...
            <?php
              ...
              <?php }
                    ...
                    echo '<p class="alert alert-info text-center">هنوز نظری برای این استاد ثبت نشده است اولین نظر را ارسال کنید</p>';
                } ?>
            </div>
            <?php sendComment(); ?>
            <div class="col-md-4">
